...
public class Logic
    ...
    {
        double periOfRect = 2*(length+width);
        return periOfRect;
    }
    ...
    {
        double areaOfRightTriangle = (base*height)/2;
        return areaOfRightTriangle;
    }
    public static double rightTrianglePerimeter(double base, double height)
    {
        double periOfRightTriangle = base+height+(Math.sqrt(((base*base) + (height*height))));
        return periOfRightTriangle;
    }
    public static double boxVolume(double length, double width, double depth)
    {
        double volOfBox = length*width*depth;
        return volOfBox;
    }
    public static double boxSurfaceArea(double length, double width,
                                        double depth)
    {
        double surfaceAreaBox = (2*length*width) + (2*width*depth) + (2*length*depth);
        return  surfaceAreaBox;
    }
    public static double sphereVolume(double radius)
    {
        double volSphere = ((4.00/3.00) * Math.PI * (radius*radius*radius));
        return volSphere;
    }
